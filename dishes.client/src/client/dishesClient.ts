...
/**
 * Instantiates a new {@link DishesClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createDishesClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<DishesClient>(requestAdapter, pathParameters, DishesClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface DishesClient extends BaseRequestBuilder<DishesClient> {
    /**
     * The api property
     */
 ...
 */
export const DishesClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const DishesClientNavigationMetadata: Record<Exclude<keyof DishesClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
